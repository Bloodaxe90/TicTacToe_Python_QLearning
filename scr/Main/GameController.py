...
class GameController(QObject):
    ...
    def __init__(self, view) -> None:
        ...
        self.play_minimax_checkbox = None
        ...
        if not self.stop:
            ...
            if isinstance(sender, QPushButton):
                if sender in self.actual_board and sender.text() == "":
                    ...
                    if self.play_minimax_checkbox.isChecked():
                        # Verse AI
    ...
    def set_up_option_buttons(self):
        self.play_minimax_checkbox = self.view.findChild(QCheckBox, "playMinimax")
    ...
    def reset(self) -> None:
        ...
        self.play_minimax_checkbox.setDisabled(False)
